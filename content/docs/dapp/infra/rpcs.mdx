...
import { Server, Container, Cloud, Zap, Network } from "lucide-react";
...
<Cards className="sm:grid-cols-3">
  ...
  <Card title="Tenderly" href="https://tenderly.co/?mtm_campaign=ext-docs&mtm_kwd=metis" external icon={<Network />} />
</Cards>
