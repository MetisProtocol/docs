...
import { Network, Database, Boxes, Layers } from "lucide-react";
...
There are several indexer solutions available, each offering different levels of decentralization, ease of development, and performance for you to consider. These solutions serve as intermediaries to assist in indexing the Metis network.

<Cards className="sm:grid-cols-3">
  <Card title="the_graph" href="indexers/the_graph" icon={<Network />} />
  <Card title="0xgraph" href="indexers/0xgraph" icon={<Database />} />
  <Card title="Envio" href="indexers/envio" icon={<Boxes />} />
  <Card title="Flair" href="indexers/flair" icon={<Layers />} />
</Cards>
