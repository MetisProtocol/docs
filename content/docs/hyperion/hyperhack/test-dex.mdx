...
3. **Provide Liquidity**:
   - Go to the "Pool" or "Liquidity" section.
...
1. **Access the Subgraph**:
   ...
   - Use the subgraph endpoint: [https://subgraph.metis.io/subgraphs/name/hype-test-dex](https://subgraph.metis.io/subgraphs/name/hype-test-dex)
