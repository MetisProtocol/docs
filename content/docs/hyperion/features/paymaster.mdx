...
The Paymaster system consists of several interconnected contracts:

```
┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│                 │     │                 │     │                 │
│  EntryPoint     │────▶│  Paymaster      │────▶│  TokenRegistry  │
...
- **Signature Schemes**: Support for diverse signing methods
