...
6. **Batch Submission to Ethereum (L1):**
   - The signed batch is submitted to the Ethereum Layer 1 via the [Bridge & Adapter module](/docs/sequencer/architecture/bridge).
