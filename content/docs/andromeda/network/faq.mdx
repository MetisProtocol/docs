...
<Accordions>
    ...
    <Accordion title="What is a wrapped Metis token?">
     ...
     <Accordion title="What Version of Ethereum is Metis Compatible With?">
        Metis has support for the Berlin and `PUSH0` opcode with the Shanghai upgrade. Metis does not support the Cancun upgrade yet. The latest Solidity version that Metis Andromeda supports is **v0.8.23**.
    </Accordion>
