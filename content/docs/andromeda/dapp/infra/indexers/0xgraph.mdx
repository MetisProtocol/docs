...
A product by Ormi, delivers a comprehensive, backwards-compatible subgraph solution that combines advanced indexing capabilities with seamless hosting. It is designed to simplify blockchain data access.

<Cards>
  <Card
    title="0xgraph"
    href="https://0xgraph.com"
    external
    icon={<Database />}
  />
  <Card
    title="Template"
    href="https://github.com/metis-edu/ormi-metis-template"
    external
    icon={<LayoutPanelTop />}
  />
</Cards>
