...
import NFTGallery from "@/components/rainbowkit/NFTGallery";
...
The code for this is located [here](https://github.com/MetisProtocol/docs/blob/main/components/rainbowkit/NFTGallery.tsx).
